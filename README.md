...
fa ann 300750.SHE --focus governance  # 查 A 股公告：减持/增持/治理/质押/处罚等
...
fa/
  ...
  tools/announcements.py # Wind DB A股公告查询
...
本机 Wind DB 数据边界见 `docs/DATA_SOURCES.md`：研报库主要是索引/摘要，公告库有 A 股正文或 PDF 链接。
